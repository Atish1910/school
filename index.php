...
<body>
                ...
                <div class="collapse navbar-collapse justify-content-end align-items-center" id="navbarCollapse">
                    <div class="navbar-nav">
                        <div class="pt-5 pt-lg-0">
                            <button type="submit" class="btn c_btn" data-bs-toggle="modal"
    ...
    <div class="overflow-hidden">
        ...
        <section class="bg-grad02 hero-01">
            <div class="container">
                <div class="row align-items-center ">
                    <div class="col-lg-4 py-lg-5  order-lg-1 order-2">
                        <div class="event-info-box text-white">
                            ...
                            <div class="bg-yellow p-1 rounded-pill  d-none d-lg-grid">
                    ...
                    <div class="col-lg-5 py-4 py-lg-0  order-lg-2 order-1">
                        <div class="vertical-columns">
                            ...
                            <div class="v-col col-3">
                                <div class="v-track">
                                    <div class="v-item"><img src="images-01/hero/3.png"></div>
                                    <div class="v-item"><img src="images-01/hero/6.png"></div>
                                    <div class="v-item"><img src="images-01/hero/9.png"></div>
                    ...
                    <div class="col-lg-3 py-5 order-3 d-none d-lg-flex">
        ...
        <!-- ------------------------------------------------------------------------------------------------------------------ -->
        <section class="py-lg-5 pt-5 bg-white" id="gallery">
            <div class="container">
                <div class="row gy-4 hero-01 px-2">
                    <div class="bg-yellow p-1 rounded-pill   d-lg-none">
                        <div class="event-card d-flex justify-content-between align-items-center">
                            <div class="event-location">
                                <strong>Apparel House,</strong>
                                <p class="mb-0 text-lg-center">Sec 44, Gurugram</p>
        ...
        <!-- ----------------------------------------------------------------------------------------------------------- -->
        <section class="pb-5  bg-white" id="placement">
            <div class="container rounded">
                <div class="row justify-content-center company">
                    <div class="col-md-12  rounded-3  ">
                        ...
                        <div class="row school-01 py-3 rounded-3  owl-carousel justify-content-center text-center">
                            <?php
                        ...
                        <div class="row school-02 owl-carousel justify-content-center text-center  pt-3 rounded-3  ">
                            <?php
        ...
        <section class="school-category-section py-5 bg-white">
            <div class="container">
                <div class="row ">
                    <div class="col-lg-12 text-center">
                        <h3 class="mb-4 fw-bold text-blue-d">Choose the School That Fits You Best</h3>
                    </div>
                </div>
        ...
        <section class="schedule-bg">
            ...
            <div class="container  px-0">
                <div class="row align-items-center px-0">
                    <div class="col-lg-6 schedule-section d-flex align-items-center py-5 ps-4">
                        <div>
                            <div class="">
                                <p class="text-purple mb-0 h5"><i>Exciting Opportunities for Parents!</i></p>
                                <h3 class="fw-normal Pre-schedule">Pre-schedule Your <br> School Appointments</h3>
                                <p class="text-purple h5"><i>To Avoid Rush</i></p>
                            </div>
                            <div class="">
                                <button type="submit" class="btn c_btn"  data-bs-toggle="modal" data-bs-target="#exampleModal">
                                    <span class="icon-box-01 p-2">
                                        <i class="bi bi-arrow-up-right"></i>
                                    </span>
                    ...
                    <div class="col-lg-6 d-lg-none">
                        <img src="images-01/background-01/1.png" class="w-100" alt="">
                    </div>
        ...
        <section class="bg-exhibition" id="testimonals">
            <div class="container pt-lg-5 pb-lg-0 py-5 ">
                ...
                <div class="row exhibition-01 owl-carousel">
                    <?php foreach ($testimonials as $item) { ?>
                    <div class="col-lg-12 item testimonial-items mb-4 p-3 justify-content-center">
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog p-0 ">
                <div class="modal-content  bg-blue-l ">
